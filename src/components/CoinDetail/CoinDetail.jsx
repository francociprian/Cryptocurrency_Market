  ...
  return (
    <>
      ...
      (<div className='max-w-5xl mx-auto'>
          ...
          <div key={selectedCoin.id} className='flex justify-around gap-10 my-4 bg-lime-300 text-black'>
            <div>
              <div className='flex justify-center items-center'>
                ...
                <p className='text-5xl flex items-center'>
                  {selectedCoin.name}
                  <span className='ml-2 text-xs border-[1px] p-1 rounded-md uppercase'>{selectedCoin.symbol}</span>  
                </p> 
              </div>
          ...
          <CoinDetailChart id={selectedCoin.id}/>
        </div>)}
    </>
  )
}
